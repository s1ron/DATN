...
const StickerMessage = ({avartarImage, DeleteMessage, message, userId})=>{
    ...
    return(
        <div className={`${own?"flex-row-reverse":"flex-row"} justify-start flex w-full px-2 gap-1 group/message`}>
            ...
            <div className="rounded-xl">
                <img className="h-24 rounded-xl" src={`${process.env.REACT_APP_BASEURL}${message.filePath}`} alt="imagePath" loading="lazy" />
            </div>
